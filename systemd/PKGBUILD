...
package_systemd() {
  ...
  install -Dm644 manjaro.conf "$pkgdir"/usr/share/systemd/bootctl/manjaro.conf
  install -Dm644 loader.conf "$pkgdir"/usr/share/systemd/bootctl/loader.conf
  install -Dm644 splash-manjaro.bmp "$pkgdir"/usr/share/systemd/bootctl/splash-manjaro.bmp
